...
def main():
    Input_Image = "C:\\Users\\MAHE\\Desktop\\8th Sem Project\\Dicom_to_Image-Python-master\\Dicom_to_Image-Python-master\\IMAGE3"

    Output_Image, Instance_Number = Dicom_to_Image(Input_Image)

    cv.imwrite(str(Instance_Number - 1).zfill(4) + '.png', Output_Image)
