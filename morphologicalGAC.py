...
def generate_mask(PATH_IMG1,PATH_IMG2):
    ...
    for x in range(len(image1)):
        ...
        for y in range(len(image1[0])):
            t = 255*255*(1-image1[x][y])*(1-image2[x][y])
            row.append(t)
...
PATH_IMG1 = 'pseudo_1.png'
PATH_IMG2 = 'pseudo_4_max.png'
...
if __name__ == '__main__':
    ...
    mask1 = matrixToImg(image1_array,"mask1.png")
    mask2 = matrixToImg(image2_array,"mask2.png")